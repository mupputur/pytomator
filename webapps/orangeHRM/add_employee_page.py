...
class AddEmployeePage:
    ...
    def add_employee_with_out_login_details_cus_empid(self, first_name,middle_name,last_name,employee_id):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(5)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
        ...
        self.helper.enter_text(lastname, last_name)
        time.sleep(5)
        employeeid = self.helper.identify_element(lp.EMPLOYEE_ID_TB_XPATH_LOC[0], lp.EMPLOYEE_ID_TB_XPATH_LOC[1], "employeeid")
        self.helper.enter_text(employeeid, employee_id)
        time.sleep(3)
        save = self.helper.identify_element(lp.SAVE_BT_XPATH_LOC[0],lp.SAVE_BT_XPATH_LOC[1], "click_save")
        save.click()
        time.sleep(5)
    ...
    def add_existing_employee_with_out_login_details_diff_empid(self, first_name,middle_name,last_name,employee_id):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(5)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
    ...
    def add_existing_employee_with_out_login_details_same_empid(self, first_name,middle_name,last_name,employee_id):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(5)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
    ...
    def add_employee_with_out_login_details_blank_fields(self, first_name,middle_name,last_name):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(5)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
    ...
    def add_employee_with_login_details_exist_username(self,first_name,middle_name,last_name,user_name,_password,_confirm_password):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(3)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
    ...
    def add_employee_with_login_details_diff_pwd_confpwd(self,first_name,middle_name,last_name,user_name,_password,_confirm_password):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(3)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
    ...
    def add_employee_with_login_details_wrong_pwd_credential(self,first_name,middle_name,last_name,user_name,_password,_confirm_password):
        firstname = self.helper.identify_element(lp.FIRSTNAME_TB_XPATH_LOC[0],lp.FIRSTNAME_TB_XPATH_LOC[1], "firstname")
        self.helper.enter_text(firstname,first_name)
        time.sleep(3)
        middlename = self.helper.identify_element(lp.MIDDLENAME_TB_XPATH_LOC[0],lp.MIDDLENAME_TB_XPATH_LOC[1], "middlename")
